  ...
  <div className="jumbotron" id="aboutUs-page">
    ...
    <div className="container text-center">
      ...
      <p className="lead">
        ...
        paper presentations, robotics software development, aero-modelling, quizzes to managerial events.
        The year 2013 marked the Golden-Jubilee of NIT Kurukshetra and thus the mega techno-managerial festival
        was re-christened "TECHSPARDHA".
      </p>
